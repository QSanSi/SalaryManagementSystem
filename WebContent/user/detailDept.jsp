		...
		<div>
			<table width="100%" class="top" cellpadding="0" cellspacing="0">
				<tr>
					...
					<a href="deptList.action">部门管理</a>>>显示部门详细信息</td>
				</tr>
			</table>
		</div>
		<div height="100%" style="margin-top: 10px;">
			<fieldset style="width: 98%">
				<legend style="font-size:16px;">部门详情如下：</legend>
				...
				<form action="dept!update.action" method="post">
					...
					<table class="list_dept" border="0" cellpadding="0" cellspacing="10">
						...
						<tr>
							<th>部门名称：</th>
							<td><input type="text" name="dept.name" value="${dept.name}" /></td>
							<th>部门编号：</th>
							<td><input type="text" name="dept.number"
								value="${dept.number}" /></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							<th>部门电话：</th>
							<td><input type="text" name="dept.tel" value="${dept.tel}" /></td>
							<th>部门负责人：</th>
							<td><input type="text" name="dept.manager"
								value="${dept.manager}" /></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							<th>部门简介：</th>
							<td colspan="3" style="height: 42px"><textarea
									...
									style="border: 1px solid gray; overflow: hidden;">${dept.remark}</textarea>
							</td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
