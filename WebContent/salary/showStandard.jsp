...
<script type="text/javascript">
		$(document).ready(function(){		
			...
			$("#go").click(function(){
				...
				$("#go").attr("href","emppageSelectStand.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d);
		      }); 
			$("#first").click(function(){
				var i = $("#empid").val();
				var n = $("#truename").val();
				var d = $("#dept").val();
				$("#first").attr("href","emppageSelectStand.action?page=1&empId=" + i + "&trueName=" + n + "&dept=" + d);
		      }); 
			$("#pre").click(function(){
				var i = $("#empid").val();
				var n = $("#truename").val();
				...
				$("#pre").attr("href","emppageSelectStand.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d);
		      }); 
			$("#next").click(function(){
				var i = $("#empid").val();
				var n = $("#truename").val();
				var d = $("#dept").val();
				var number = "${requestScope.page+1}";
				$("#next").attr("href","emppageSelectStand.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d);
		      }); 
			$("#last").click(function(){
				var i = $("#empid").val();
				var n = $("#truename").val();
				...
				$("#last").attr("href","emppageSelectStand.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d);
		      }); 
		});	
</script>
			...
			<table border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
				...
				<c:forEach items="${salaryStandards}" var="salaryStandard" varStatus="i">
					<tr class="list" bgcolor="#FFFFFF">
						...
						<td><a
							href="salaryStandard!load.action?salaryStandard.id=${salaryStandard.id}">
