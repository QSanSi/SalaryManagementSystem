...
<script type="text/javascript">
	...
	$(document).ready(function(){		
		...
		$("#go").click(function(){
			...
			$("#go").attr("href","emppageSelectSalary.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d + "&syear=" + y + "&smonth=" + m);
	      }); 
		$("#first").click(function(){
			...
			var m = $("#month").val();
			var d = $("#dept").val();
			$("#first").attr("href","emppageSelectSalary.action?page=1&empId=" + i + "&trueName=" + n + "&dept=" + d + "&syear=" + y + "&smonth=" + m);
	      }); 
		$("#pre").click(function(){
			var i = $("#empid").val();
			var n = $("#truename").val();
			...
			$("#pre").attr("href","emppageSelectSalary.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d + "&syear=" + y + "&smonth=" + m);
	      }); 
		$("#next").click(function(){
			var i = $("#empid").val();
			var n = $("#truename").val();
			...
			var d = $("#dept").val();
			var number = "${requestScope.page+1}";
			$("#next").attr("href","emppageSelectSalary.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d + "&syear=" + y + "&smonth=" + m);
	      }); 
		$("#last").click(function(){
			var i = $("#empid").val();
			var n = $("#truename").val();
			...
			$("#last").attr("href","emppageSelectSalary.action?page=" + number + "&empId=" + i + "&trueName=" + n + "&dept=" + d + "&syear=" + y + "&smonth=" + m);
	      }); 
	});
</script>
...
<body>
	<div class="table_top" style="height: 100%">
		...
		<div height="100%" style="margin-top: 10px;">
			...
			月份：<select id="month" name="salary.month">
			...
			<div style="float: left;">
				<s:form action="addSalarys" method="post" theme="simple">
					<input id="dept2" name="salary.dept" style="display: none">
